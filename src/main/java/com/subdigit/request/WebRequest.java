...
public abstract class WebRequest<UserType> extends BasicRequest<String>
{
	...
	public boolean hasVersionParameter(){ return (extractVersion() != null)?true:false; }
	...
	public boolean hasActionParameter(){ return (extractAction() != null)?true:false; }
